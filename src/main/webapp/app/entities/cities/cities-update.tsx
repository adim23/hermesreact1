  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.cities.home.createOrEditLabel" data-cy="CitiesCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.cities.home.createOrEditLabel">Create or edit a Cities</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.cities.name')}
                id="cities-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.president')}
                id="cities-president"
                name="president"
                data-cy="president"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.presidentsPhone')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.secretary')}
                id="cities-secretary"
                name="secretary"
                data-cy="secretary"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.secretarysPhone')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.police')}
                id="cities-police"
                name="police"
                data-cy="police"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.policesPhone')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.doctor')}
                id="cities-doctor"
                name="doctor"
                data-cy="doctor"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.doctorsPhone')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.teacher')}
                id="cities-teacher"
                name="teacher"
                data-cy="teacher"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.teachersPhone')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.priest')}
                id="cities-priest"
                name="priest"
                data-cy="priest"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.cities.priestsPhone')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('hermesreact1App.cities.country')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('hermesreact1App.cities.region')}
                type="select"
                required
              >
                <option value="" key="0" />
