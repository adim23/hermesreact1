  ...
  return (
    <div>
      <h2 id="cities-heading" data-cy="CitiesHeading">
        <Translate contentKey="hermesreact1App.cities.home.title">Cities</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hermesreact1App.cities.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hermesreact1App.cities.home.createLabel">Create new Cities</Translate>
          </Link>
        </div>
      </h2>
        ...
        {citiesList && citiesList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hermesreact1App.cities.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="hermesreact1App.cities.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('president')}>
                  <Translate contentKey="hermesreact1App.cities.president">President</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('secretary')}>
                  <Translate contentKey="hermesreact1App.cities.secretary">Secretary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('police')}>
                  <Translate contentKey="hermesreact1App.cities.police">Police</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('policesPhone')}>
                  <Translate contentKey="hermesreact1App.cities.policesPhone">Polices Phone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('doctor')}>
                  <Translate contentKey="hermesreact1App.cities.doctor">Doctor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('doctorsPhone')}>
                  <Translate contentKey="hermesreact1App.cities.doctorsPhone">Doctors Phone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('teacher')}>
                  <Translate contentKey="hermesreact1App.cities.teacher">Teacher</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('teachersPhone')}>
                  <Translate contentKey="hermesreact1App.cities.teachersPhone">Teachers Phone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('priest')}>
                  <Translate contentKey="hermesreact1App.cities.priest">Priest</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('priestsPhone')}>
                  <Translate contentKey="hermesreact1App.cities.priestsPhone">Priests Phone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="hermesreact1App.cities.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="hermesreact1App.cities.region">Region</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hermesreact1App.cities.home.notFound">No Cities found</Translate>
            </div>
          )
        )}
      </div>
