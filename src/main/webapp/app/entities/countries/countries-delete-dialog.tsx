...
export const CountriesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.countries.delete.question">
        <Translate contentKey="hermesreact1App.countries.delete.question" interpolate={{ id: countriesEntity.id }}>
