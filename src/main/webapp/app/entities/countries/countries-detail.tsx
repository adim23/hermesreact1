    ...
    <Row>
      <Col md="8">
        <h2 data-cy="countriesDetailsHeading">
          <Translate contentKey="hermesreact1App.countries.detail.title">Countries</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.countries.name">Name</Translate>
            </span>
          </dt>
          <dd>{countriesEntity.name}</dd>
          <dt>
            <span id="iso">
              <Translate contentKey="hermesreact1App.countries.iso">Iso</Translate>
            </span>
          </dt>
          <dd>{countriesEntity.iso}</dd>
          <dt>
            <span id="language">
              <Translate contentKey="hermesreact1App.countries.language">Language</Translate>
            </span>
          </dt>
          <dd>{countriesEntity.language}</dd>
          <dt>
            <span id="lang">
              <Translate contentKey="hermesreact1App.countries.lang">Lang</Translate>
            </span>
          </dt>
