  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.countries.home.createOrEditLabel" data-cy="CountriesCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.countries.home.createOrEditLabel">Create or edit a Countries</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.countries.name')}
                id="countries-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField label={translate('hermesreact1App.countries.iso')} id="countries-iso" name="iso" data-cy="iso" type="text" />
              <ValidatedField
                label={translate('hermesreact1App.countries.language')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.countries.lang')}
                id="countries-lang"
                name="lang"
                data-cy="lang"
                type="text"
