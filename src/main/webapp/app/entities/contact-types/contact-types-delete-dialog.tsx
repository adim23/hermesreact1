...
export const ContactTypesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.contactTypes.delete.question">
        <Translate contentKey="hermesreact1App.contactTypes.delete.question" interpolate={{ id: contactTypesEntity.id }}>
