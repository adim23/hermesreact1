  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.citizensRelations.home.createOrEditLabel" data-cy="CitizensRelationsCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.citizensRelations.home.createOrEditLabel">Create or edit a CitizensRelations</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.citizensRelations.name')}
              ...
              <ValidatedField
                ...
                name="citizen"
                data-cy="citizen"
                label={translate('hermesreact1App.citizensRelations.citizen')}
                type="select"
              >
                <option value="" key="0" />
                {citizens
