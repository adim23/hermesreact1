    ...
    <Row>
      <Col md="8">
        <h2 data-cy="emailsDetailsHeading">
          <Translate contentKey="hermesreact1App.emails.detail.title">Emails</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="email">
              <Translate contentKey="hermesreact1App.emails.email">Email</Translate>
            </span>
          </dt>
          <dd>{emailsEntity.email}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="hermesreact1App.emails.description">Description</Translate>
            </span>
          </dt>
          <dd>{emailsEntity.description}</dd>
          <dt>
            <span id="favourite">
              <Translate contentKey="hermesreact1App.emails.favourite">Favourite</Translate>
            </span>
          </dt>
          <dd>{emailsEntity.favourite ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.emails.kind">Kind</Translate>
          </dt>
          <dd>{emailsEntity.kind ? emailsEntity.kind.name : ''}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.emails.citizen">Citizen</Translate>
          </dt>
