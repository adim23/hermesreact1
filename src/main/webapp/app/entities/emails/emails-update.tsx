  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.emails.home.createOrEditLabel" data-cy="EmailsCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.emails.home.createOrEditLabel">Create or edit a Emails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.emails.email')}
                id="emails-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.emails.description')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.emails.favourite')}
                id="emails-favourite"
                name="favourite"
                data-cy="favourite"
                check
                type="checkbox"
              />
              <ValidatedField id="emails-kind" name="kind" data-cy="kind" label={translate('hermesreact1App.emails.kind')} type="select">
                <option value="" key="0" />
                {contactTypes
              ...
              <ValidatedField
                ...
                name="citizen"
                data-cy="citizen"
                label={translate('hermesreact1App.emails.citizen')}
                type="select"
              >
                <option value="" key="0" />
                {citizens
