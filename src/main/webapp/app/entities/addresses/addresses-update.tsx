  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.addresses.home.createOrEditLabel" data-cy="AddressesCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.addresses.home.createOrEditLabel">Create or edit a Addresses</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.addresses.address')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.addressNo')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.zipCode')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.prosfLetter')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.nameLetter')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.letterClose')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.firstLabel')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.secondLabel')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.thirdLabel')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.fourthLabel')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.fifthLabel')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.addresses.favourite')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('hermesreact1App.addresses.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
              ...
              <ValidatedField
                ...
                name="kind"
                data-cy="kind"
                label={translate('hermesreact1App.addresses.kind')}
                type="select"
              >
                <option value="" key="0" />
                {contactTypes
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('hermesreact1App.addresses.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
              ...
              <ValidatedField
                ...
                name="company"
                data-cy="company"
                label={translate('hermesreact1App.addresses.company')}
                type="select"
              >
                <option value="" key="0" />
                {companies
              ...
              <ValidatedField
                ...
                name="citizen"
                data-cy="citizen"
                label={translate('hermesreact1App.addresses.citizen')}
                type="select"
              >
                <option value="" key="0" />
                {citizens
