...
export const AddressesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.addresses.delete.question">
        <Translate contentKey="hermesreact1App.addresses.delete.question" interpolate={{ id: addressesEntity.id }}>
