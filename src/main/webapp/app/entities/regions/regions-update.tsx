  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.regions.home.createOrEditLabel" data-cy="RegionsCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.regions.home.createOrEditLabel">Create or edit a Regions</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.regions.name')}
                id="regions-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('hermesreact1App.regions.country')}
                type="select"
                required
              >
                <option value="" key="0" />
