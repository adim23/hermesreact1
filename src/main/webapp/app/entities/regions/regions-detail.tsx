    ...
    <Row>
      <Col md="8">
        <h2 data-cy="regionsDetailsHeading">
          <Translate contentKey="hermesreact1App.regions.detail.title">Regions</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.regions.name">Name</Translate>
            </span>
          </dt>
          <dd>{regionsEntity.name}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.regions.country">Country</Translate>
          </dt>
