  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.teams.home.createOrEditLabel" data-cy="TeamsCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.teams.home.createOrEditLabel">Create or edit a Teams</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.teams.name')}
                id="teams-name"
                name="name"
                data-cy="name"
                type="text"
