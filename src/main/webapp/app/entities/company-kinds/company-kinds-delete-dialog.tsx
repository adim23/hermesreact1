...
export const CompanyKindsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.companyKinds.delete.question">
        <Translate contentKey="hermesreact1App.companyKinds.delete.question" interpolate={{ id: companyKindsEntity.id }}>
