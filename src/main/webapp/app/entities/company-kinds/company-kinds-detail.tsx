    ...
    <Row>
      <Col md="8">
        <h2 data-cy="companyKindsDetailsHeading">
          <Translate contentKey="hermesreact1App.companyKinds.detail.title">CompanyKinds</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.companyKinds.name">Name</Translate>
            </span>
          </dt>
