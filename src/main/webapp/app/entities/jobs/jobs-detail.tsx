    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobsDetailsHeading">
          <Translate contentKey="hermesreact1App.jobs.detail.title">Jobs</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.jobs.name">Name</Translate>
            </span>
          </dt>
          <dd>{jobsEntity.name}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="hermesreact1App.jobs.description">Description</Translate>
            </span>
          </dt>
