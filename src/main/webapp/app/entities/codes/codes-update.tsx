  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.codes.home.createOrEditLabel" data-cy="CodesCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.codes.home.createOrEditLabel">Create or edit a Codes</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.codes.name')}
                id="codes-name"
                name="name"
                data-cy="name"
                type="text"
