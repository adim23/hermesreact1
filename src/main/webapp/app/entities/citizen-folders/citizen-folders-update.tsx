  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.citizenFolders.home.createOrEditLabel" data-cy="CitizenFoldersCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.citizenFolders.home.createOrEditLabel">Create or edit a CitizenFolders</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.citizenFolders.name')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizenFolders.description')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizenFolders.special')}
