    ...
    <Row>
      <Col md="8">
        <h2 data-cy="citizenFoldersDetailsHeading">
          <Translate contentKey="hermesreact1App.citizenFolders.detail.title">CitizenFolders</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.citizenFolders.name">Name</Translate>
            </span>
          </dt>
          <dd>{citizenFoldersEntity.name}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="hermesreact1App.citizenFolders.description">Description</Translate>
            </span>
          </dt>
          <dd>{citizenFoldersEntity.description}</dd>
          <dt>
            <span id="special">
              <Translate contentKey="hermesreact1App.citizenFolders.special">Special</Translate>
            </span>
          </dt>
