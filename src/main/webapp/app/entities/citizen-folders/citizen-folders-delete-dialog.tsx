...
export const CitizenFoldersDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.citizenFolders.delete.question">
        <Translate contentKey="hermesreact1App.citizenFolders.delete.question" interpolate={{ id: citizenFoldersEntity.id }}>
