  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.companies.home.createOrEditLabel" data-cy="CompaniesCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.companies.home.createOrEditLabel">Create or edit a Companies</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.companies.name')}
                id="companies-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              <ValidatedField
                ...
                name="kind"
                data-cy="kind"
                label={translate('hermesreact1App.companies.kind')}
                type="select"
              >
                <option value="" key="0" />
                {companyKinds
