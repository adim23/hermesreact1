...
export const CompaniesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.companies.delete.question">
        <Translate contentKey="hermesreact1App.companies.delete.question" interpolate={{ id: companiesEntity.id }}>
