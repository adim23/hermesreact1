    ...
    <Row>
      <Col md="8">
        <h2 data-cy="companiesDetailsHeading">
          <Translate contentKey="hermesreact1App.companies.detail.title">Companies</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.companies.name">Name</Translate>
            </span>
          </dt>
          <dd>{companiesEntity.name}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.companies.kind">Kind</Translate>
          </dt>
