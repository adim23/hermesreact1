...
export const PhoneTypesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.phoneTypes.delete.question">
        <Translate contentKey="hermesreact1App.phoneTypes.delete.question" interpolate={{ id: phoneTypesEntity.id }}>
