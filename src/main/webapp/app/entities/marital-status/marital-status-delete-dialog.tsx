...
export const MaritalStatusDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.maritalStatus.delete.question">
        <Translate contentKey="hermesreact1App.maritalStatus.delete.question" interpolate={{ id: maritalStatusEntity.id }}>
