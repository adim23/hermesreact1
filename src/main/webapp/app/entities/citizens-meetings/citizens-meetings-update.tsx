  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.citizensMeetings.home.createOrEditLabel" data-cy="CitizensMeetingsCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.citizensMeetings.home.createOrEditLabel">Create or edit a CitizensMeetings</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.citizensMeetings.meetDate')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizensMeetings.agenda')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizensMeetings.comments')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizensMeetings.amount')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizensMeetings.quantity')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizensMeetings.status')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizensMeetings.flag')}
              ...
              <ValidatedField
                ...
                name="citizen"
                data-cy="citizen"
                label={translate('hermesreact1App.citizensMeetings.citizen')}
                type="select"
              >
                <option value="" key="0" />
                {citizens
