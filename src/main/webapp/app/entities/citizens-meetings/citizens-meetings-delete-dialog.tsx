...
export const CitizensMeetingsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.citizensMeetings.delete.question">
        <Translate contentKey="hermesreact1App.citizensMeetings.delete.question" interpolate={{ id: citizensMeetingsEntity.id }}>
