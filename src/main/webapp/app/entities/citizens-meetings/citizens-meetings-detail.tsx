    ...
    <Row>
      <Col md="8">
        <h2 data-cy="citizensMeetingsDetailsHeading">
          <Translate contentKey="hermesreact1App.citizensMeetings.detail.title">CitizensMeetings</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="meetDate">
              <Translate contentKey="hermesreact1App.citizensMeetings.meetDate">Meet Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="agenda">
              <Translate contentKey="hermesreact1App.citizensMeetings.agenda">Agenda</Translate>
            </span>
          </dt>
          <dd>{citizensMeetingsEntity.agenda}</dd>
          <dt>
            <span id="comments">
              <Translate contentKey="hermesreact1App.citizensMeetings.comments">Comments</Translate>
            </span>
          </dt>
          <dd>{citizensMeetingsEntity.comments}</dd>
          <dt>
            <span id="amount">
              <Translate contentKey="hermesreact1App.citizensMeetings.amount">Amount</Translate>
            </span>
          </dt>
          <dd>{citizensMeetingsEntity.amount}</dd>
          <dt>
            <span id="quantity">
              <Translate contentKey="hermesreact1App.citizensMeetings.quantity">Quantity</Translate>
            </span>
          </dt>
          <dd>{citizensMeetingsEntity.quantity}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="hermesreact1App.citizensMeetings.status">Status</Translate>
            </span>
          </dt>
          <dd>{citizensMeetingsEntity.status}</dd>
          <dt>
            <span id="flag">
              <Translate contentKey="hermesreact1App.citizensMeetings.flag">Flag</Translate>
            </span>
          </dt>
          <dd>{citizensMeetingsEntity.flag ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.citizensMeetings.citizen">Citizen</Translate>
          </dt>
