  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.phones.home.createOrEditLabel" data-cy="PhonesCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.phones.home.createOrEditLabel">Create or edit a Phones</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.phones.phone')}
                id="phones-phone"
                name="phone"
                data-cy="phone"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.phones.description')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.phones.favourite')}
                id="phones-favourite"
                name="favourite"
                data-cy="favourite"
                check
                type="checkbox"
              />
              <ValidatedField id="phones-kind" name="kind" data-cy="kind" label={translate('hermesreact1App.phones.kind')} type="select">
                <option value="" key="0" />
                {phoneTypes
              ...
              <ValidatedField
                ...
                name="company"
                data-cy="company"
                label={translate('hermesreact1App.phones.company')}
                type="select"
              >
                <option value="" key="0" />
                {companies
              ...
              <ValidatedField
                ...
                name="citizen"
                data-cy="citizen"
                label={translate('hermesreact1App.phones.citizen')}
                type="select"
              >
                <option value="" key="0" />
                {citizens
