    ...
    <Row>
      <Col md="8">
        <h2 data-cy="phonesDetailsHeading">
          <Translate contentKey="hermesreact1App.phones.detail.title">Phones</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="phone">
              <Translate contentKey="hermesreact1App.phones.phone">Phone</Translate>
            </span>
          </dt>
          <dd>{phonesEntity.phone}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="hermesreact1App.phones.description">Description</Translate>
            </span>
          </dt>
          <dd>{phonesEntity.description}</dd>
          <dt>
            <span id="favourite">
              <Translate contentKey="hermesreact1App.phones.favourite">Favourite</Translate>
            </span>
          </dt>
          <dd>{phonesEntity.favourite ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.phones.kind">Kind</Translate>
          </dt>
          <dd>{phonesEntity.kind ? phonesEntity.kind.name : ''}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.phones.company">Company</Translate>
          </dt>
          <dd>{phonesEntity.company ? phonesEntity.company.name : ''}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.phones.citizen">Citizen</Translate>
          </dt>
