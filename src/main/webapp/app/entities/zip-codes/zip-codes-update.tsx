  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.zipCodes.home.createOrEditLabel" data-cy="ZipCodesCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.zipCodes.home.createOrEditLabel">Create or edit a ZipCodes</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.zipCodes.street')}
                id="zip-codes-street"
                name="street"
                data-cy="street"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.zipCodes.area')}
                id="zip-codes-area"
                name="area"
                data-cy="area"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.zipCodes.fromNumber')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.zipCodes.toNumber')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('hermesreact1App.zipCodes.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('hermesreact1App.zipCodes.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
              ...
              <ValidatedField
                ...
                name="city"
                data-cy="city"
                label={translate('hermesreact1App.zipCodes.city')}
                type="select"
              >
                <option value="" key="0" />
                {cities
