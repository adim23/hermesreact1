    ...
    <Row>
      <Col md="8">
        <h2 data-cy="zipCodesDetailsHeading">
          <Translate contentKey="hermesreact1App.zipCodes.detail.title">ZipCodes</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="street">
              <Translate contentKey="hermesreact1App.zipCodes.street">Street</Translate>
            </span>
          </dt>
          <dd>{zipCodesEntity.street}</dd>
          <dt>
            <span id="area">
              <Translate contentKey="hermesreact1App.zipCodes.area">Area</Translate>
            </span>
          </dt>
          <dd>{zipCodesEntity.area}</dd>
          <dt>
            <span id="fromNumber">
              <Translate contentKey="hermesreact1App.zipCodes.fromNumber">From Number</Translate>
            </span>
          </dt>
          <dd>{zipCodesEntity.fromNumber}</dd>
          <dt>
            <span id="toNumber">
              <Translate contentKey="hermesreact1App.zipCodes.toNumber">To Number</Translate>
            </span>
          </dt>
          <dd>{zipCodesEntity.toNumber}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.zipCodes.country">Country</Translate>
          </dt>
          <dd>{zipCodesEntity.country ? zipCodesEntity.country.name : ''}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.zipCodes.region">Region</Translate>
          </dt>
          <dd>{zipCodesEntity.region ? zipCodesEntity.region.name : ''}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.zipCodes.city">City</Translate>
          </dt>
