  ...
  return (
    <div>
      <h2 id="zip-codes-heading" data-cy="ZipCodesHeading">
        <Translate contentKey="hermesreact1App.zipCodes.home.title">Zip Codes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hermesreact1App.zipCodes.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hermesreact1App.zipCodes.home.createLabel">Create new Zip Codes</Translate>
          </Link>
        </div>
      </h2>
        ...
        {zipCodesList && zipCodesList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hermesreact1App.zipCodes.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('street')}>
                  <Translate contentKey="hermesreact1App.zipCodes.street">Street</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('area')}>
                  <Translate contentKey="hermesreact1App.zipCodes.area">Area</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('fromNumber')}>
                  <Translate contentKey="hermesreact1App.zipCodes.fromNumber">From Number</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('toNumber')}>
                  <Translate contentKey="hermesreact1App.zipCodes.toNumber">To Number</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="hermesreact1App.zipCodes.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="hermesreact1App.zipCodes.region">Region</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="hermesreact1App.zipCodes.city">City</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hermesreact1App.zipCodes.home.notFound">No Zip Codes found</Translate>
            </div>
          )
        )}
      </div>
