...
export const SocialKindsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.socialKinds.delete.question">
        <Translate contentKey="hermesreact1App.socialKinds.delete.question" interpolate={{ id: socialKindsEntity.id }}>
