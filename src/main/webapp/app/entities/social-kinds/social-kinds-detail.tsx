    ...
    <Row>
      <Col md="8">
        <h2 data-cy="socialKindsDetailsHeading">
          <Translate contentKey="hermesreact1App.socialKinds.detail.title">SocialKinds</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="code">
              <Translate contentKey="hermesreact1App.socialKinds.code">Code</Translate>
            </span>
          </dt>
          <dd>{socialKindsEntity.code}</dd>
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.socialKinds.name">Name</Translate>
            </span>
          </dt>
          <dd>{socialKindsEntity.name}</dd>
          <dt>
            <span id="call">
              <Translate contentKey="hermesreact1App.socialKinds.call">Call</Translate>
            </span>
          </dt>
