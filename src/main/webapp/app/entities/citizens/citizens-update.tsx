  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.citizens.home.createOrEditLabel" data-cy="CitizensCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.citizens.home.createOrEditLabel">Create or edit a Citizens</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.citizens.title')}
                id="citizens-title"
                name="title"
                data-cy="title"
                type="text"
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.lastname')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.firstname')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.fathersName')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.comments')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.birthDate')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.giortazi')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.male')}
                id="citizens-male"
                name="male"
                data-cy="male"
                check
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.meLetter')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.citizens.meLabel')}
                id="citizens-meLabel"
                name="meLabel"
                data-cy="meLabel"
                type="text"
              />
              <ValidatedBlobField
                label={translate('hermesreact1App.citizens.image')}
                id="citizens-image"
                name="image"
                data-cy="image"
                isImage
              ...
              <ValidatedField
                ...
                name="folder"
                data-cy="folder"
                label={translate('hermesreact1App.citizens.folder')}
                type="select"
              >
                <option value="" key="0" />
                {citizenFolders
              ...
              <ValidatedField
                ...
                name="company"
                data-cy="company"
                label={translate('hermesreact1App.citizens.company')}
                type="select"
              >
                <option value="" key="0" />
                {companies
              ...
              <ValidatedField
                ...
                label={translate('hermesreact1App.citizens.maritalStatus')}
                type="select"
              >
                <option value="" key="0" />
                {maritalStatuses
              ...
              <ValidatedField
                ...
                name="team"
                data-cy="team"
                label={translate('hermesreact1App.citizens.team')}
                type="select"
              >
                <option value="" key="0" />
                {teams
              ...
              <ValidatedField
                ...
                name="code"
                data-cy="code"
                label={translate('hermesreact1App.citizens.code')}
                type="select"
              >
                <option value="" key="0" />
                {codes
              ...
              <ValidatedField
                ...
                name="origin"
                data-cy="origin"
                label={translate('hermesreact1App.citizens.origin')}
                type="select"
              >
                <option value="" key="0" />
                {origins
              ...
              <ValidatedField id="citizens-job" name="job" data-cy="job" label={translate('hermesreact1App.citizens.job')} type="select">
                <option value="" key="0" />
                {jobs
