...
export const SocialContactsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreact1App.socialContacts.delete.question">
        <Translate contentKey="hermesreact1App.socialContacts.delete.question" interpolate={{ id: socialContactsEntity.id }}>
