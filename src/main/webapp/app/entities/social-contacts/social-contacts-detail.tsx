    ...
    <Row>
      <Col md="8">
        <h2 data-cy="socialContactsDetailsHeading">
          <Translate contentKey="hermesreact1App.socialContacts.detail.title">SocialContacts</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesreact1App.socialContacts.name">Name</Translate>
            </span>
          </dt>
          <dd>{socialContactsEntity.name}</dd>
          <dt>
            <span id="favored">
              <Translate contentKey="hermesreact1App.socialContacts.favored">Favored</Translate>
            </span>
          </dt>
          <dd>{socialContactsEntity.favored ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.socialContacts.social">Social</Translate>
          </dt>
          <dd>{socialContactsEntity.social ? socialContactsEntity.social.name : ''}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.socialContacts.kind">Kind</Translate>
          </dt>
          <dd>{socialContactsEntity.kind ? socialContactsEntity.kind.name : ''}</dd>
          <dt>
            <Translate contentKey="hermesreact1App.socialContacts.citizen">Citizen</Translate>
          </dt>
