  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreact1App.socialContacts.home.createOrEditLabel" data-cy="SocialContactsCreateUpdateHeading">
            <Translate contentKey="hermesreact1App.socialContacts.home.createOrEditLabel">Create or edit a SocialContacts</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreact1App.socialContacts.name')}
              ...
              />
              <ValidatedField
                label={translate('hermesreact1App.socialContacts.favored')}
              ...
              <ValidatedField
                ...
                name="social"
                data-cy="social"
                label={translate('hermesreact1App.socialContacts.social')}
                type="select"
              >
                <option value="" key="0" />
                {socialKinds
              ...
              <ValidatedField
                ...
                name="kind"
                data-cy="kind"
                label={translate('hermesreact1App.socialContacts.kind')}
                type="select"
              >
                <option value="" key="0" />
                {contactTypes
              ...
              <ValidatedField
                ...
                name="citizen"
                data-cy="citizen"
                label={translate('hermesreact1App.socialContacts.citizen')}
                type="select"
              >
                <option value="" key="0" />
                {citizens
